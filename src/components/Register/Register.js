...
class Register extends React.Component {
    ...
    render() {
        return (
            <article className="bg-white-10 hover-bg-white-40 shadow-hover relative z-1 br4 ba b--black-10 mt4 w-100 w-50-m w-25-l mw6 shadow-5 center"> {/*set zindex here for register form*/}
